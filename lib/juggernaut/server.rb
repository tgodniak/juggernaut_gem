  ...
  class Server < EventMachine::Connection
    ...
    def process_message(ln)
      ...
      case @request[:command].to_sym
        when :broadcast then broadcast_command
        when :subscribe then subscribe_command
        when :query     then query_command
        when :noop      then noop_command
      else
